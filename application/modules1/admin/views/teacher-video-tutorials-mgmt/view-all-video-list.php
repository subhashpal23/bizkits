   ...
   <div class="page-header">
      <div class="page-header-content">
         <div class="page-title">
            <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Video Tutorials Management</span> - View All Video List</h4>
         </div>
      </div>
      <div class="breadcrumb-line">
         <ul class="breadcrumb">
            ...
            <li class="active">View All Video List</li>
         </ul>
   ...
   <div class="content">
      ...
      <div class="panel panel-white">
         <div class="panel-heading">
            <h6 class="panel-title text-semibold">View All Video List</h6>
            ...
            <tbody>
               ...
               if(!empty($all_video) && count($all_video)>0)
               {
                  ...
                  foreach ($all_video as $video) 
                  {
					...
					$category_name=(!empty($video->category_name))?$video->category_name:'NULL';
               ...
               <tr>
				  ...
				  <td><?php echo $video->teacher_id;?></td>
                     ...
                     <ul class="icons-list">
                        <li class="dropdown">
                           ...
                           <ul class="dropdown-menu dropdown-menu-right">
                              ...
                              <?php 
                              if($video->approve_status=='0')
                              {
                              ?>
                              <li><a title="click to Publish" href="<?php echo ci_site_url();?>admin/teacher_video_tutorials/changeVideoStatus/<?php echo ID_encode($video->id);?>/1"><i class="icon-eye"></i> Approve Video</a></li>
                              <?php    
                              }
                              else 
                              {
                              ?>
                              <li><a title="click to Unpublish" href="<?php echo ci_site_url();?>admin/teacher_video_tutorials/changeVideoStatus/<?php echo ID_encode($video->id);?>/0"><i class="icon-eye-blocked"></i> Unapprove Video</a></li>
                              <?php    
                              }
                              ?>
							  
							   <li><a title="Edit" href="<?php echo ci_site_url();?>admin/teacher_video_tutorials/editVideo/<?php echo ID_encode($video->id);?>/1"><i class="icon-pencil"></i> Edit</a></li>
