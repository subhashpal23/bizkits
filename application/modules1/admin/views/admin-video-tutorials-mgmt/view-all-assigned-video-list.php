   ...
   <div class="page-header">
      <div class="page-header-content">
         <div class="page-title">
            <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Video Tutorials Management</span> - View All Assigned Video List</h4>
         </div>
      </div>
      <div class="breadcrumb-line">
         <ul class="breadcrumb">
            ...
            <li class="active">View All Assigned Video List</li>
         </ul>
   ...
   <div class="content">
      ...
      <div class="panel panel-white">
         <div class="panel-heading">
            <h6 class="panel-title text-semibold">View All Assigned Video List</h6>
                     ...
                     <ul class="icons-list">
                        <li class="dropdown">
                           ...
                           <ul class="dropdown-menu dropdown-menu-right">
                              ...
                              <li><a title="click to Unpublish" href="<?php echo ci_site_url();?>admin/admin_video_tutorials/editVideo/<?php echo ID_encode($video->id);?>"><i class="icon-eye-blocked"></i> Unassigned from Video category</a></li>
                           </ul>
                        </li>
                     </ul>
                  </td>
