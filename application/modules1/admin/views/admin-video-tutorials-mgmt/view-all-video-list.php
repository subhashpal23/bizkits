                     ...
                     <ul class="icons-list">
                        <li class="dropdown">
                           ...
                           <ul class="dropdown-menu dropdown-menu-right">
                              ...
                              {
                              ?>
                              <li><a title="click to Publish" href="<?php echo ci_site_url();?>admin/admin_video_tutorials/changeVideoStatus/<?php echo ID_encode($video->id);?>/1"><i class="icon-eye"></i> Approve Video</a></li>
                              <?php    
                              }
                              else 
                              {
