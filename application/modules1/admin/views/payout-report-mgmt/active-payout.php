               ...
               <tbody>
                  ...
                  <tr>
                     ...
                     <td>
                        <ul class="icons-list">
                           <li>
                              <a onclick="return cancelPayoutConfirm();" href="<?php echo ci_site_url();?>admin/PayoutReport/cancelPayoutRequest/<?php echo ID_encode($payout->id);?>" data-popup="tooltip" title="" data-original-title="Cancel Payout"><i class="icon-blocked"></i></a>
                           </li>
                           <li>
                              <a onclick="return releasePayoutConfirm();" href="<?php echo ci_site_url();?>admin/PayoutReport/approvePayoutRequest/<?php echo ID_encode($payout->id);?>" data-popup="tooltip" title="" data-original-title="Release Payout"><i class="icon-checkmark"></i></a>
                           </li>
                        </ul>
                     </td>
                  </tr>
