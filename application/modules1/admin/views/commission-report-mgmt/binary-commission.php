   ...
   <div class="page-header page-header-default">
      <div class="page-header-content">
         <div class="page-title">
            <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Commission Report</span> - Binary Bonus Report</h4>
         </div>
      ...
      <div class="breadcrumb-line">
         <ul class="breadcrumb">
            ...
            <li class="active">Binary Bonus Report</li>
         </ul>
      ...
      <div class="row">
         <div class="col-md-6">
            <div class="panel bg-primary">
               <div class="panel-heading">
                  <h6 class="panel-title">Total Binary commission</h6>
               </div>
               <div class="panel-body">
                  <?php 
                  echo currency()." ";
                  echo (!empty($total_binary_commission))?$total_binary_commission:0;
                  ?>
               </div>
            </div>
         </div>
         <div class="col-md-6">
            <div class="panel bg-primary">
               <div class="panel-heading">
                  <h6 class="panel-title">Total Binary commission  transaction</h6>
               </div>
               <div class="panel-body">
                  <?php 
                  echo (!empty($total_no_of_binary_commission))?$total_no_of_binary_commission:0;
                  ?>
               </div>
            </div>
         </div>
