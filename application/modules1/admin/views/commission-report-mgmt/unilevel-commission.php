   ...
   <div class="page-header page-header-default">
      <div class="page-header-content">
         <div class="page-title">
            <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Commission Report</span> - Indirect Referral Bonus Report</h4>
         </div>
      ...
      <div class="breadcrumb-line">
         <ul class="breadcrumb">
            ...
            <li class="active">Indirect Referral Bonus Report</li>
         </ul>
      ...
      <div class="row">
         <div class="panel panel-flat">
            <div class="panel-heading">
               <h5 class="panel-title">Indirect Referral Bonus Report</h5>
               <div class="heading-elements">
                  <ul class="icons-list">
               ...
               <tbody>
                  ...
                  ?>
                     <tr>
						...
						<td>Indirect Referral Income of level<?php echo $income->level;?>
						</td>
         ...
         <div class="col-md-6">
            <div class="panel bg-primary">
               ...
               <div class="panel-body">
                  <?php 
                  echo currency()." ";
                  echo (!empty($total_level_income))?$total_level_income:0;
                  ?>
               </div>
            </div>
         </div>
