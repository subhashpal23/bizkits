                        ...
                        <ul class="icons-list">
                           <li class="dropdown">
                              ...
                              <ul class="dropdown-menu dropdown-menu-right">
                                 ...
                                 <li><a onclick="return confirmCancelRequest();" href="<?php echo ci_site_url().'admin/UserWallet/cancelWalletDepositRequest/'.ID_encode($request->id);?>"><i class="icon-file-excel"></i> Cancel Request</a></li>
                              </ul>
                           </li>
                        </ul>
                     </td>
