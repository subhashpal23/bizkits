...
class Investment extends Common_Controller 
{
	...
	*/
	public function viewInvestBalance()
	{
		...
		_adminLayout("investment-mgmt/view-investment-balance",$data);
	}
	public function purchaseList()
	{
		$data=array();
		//echo $this->session->userdata('user_id');exit;
        $all_statements=$this->investment_model->getInvestmentHistory();
		$data['all_statements']=$all_statements;
		_adminLayout("investment-mgmt/view-investment-history",$data);
	}
	public function roiHistory($deposit_id)
	{
		$data=array();
        $all_statements=$this->investment_model->getInvestmentStatements($deposit_id);
		$data['all_statements']=$all_statements;
		_adminLayout("investment-mgmt/view-investment-statement",$data);
	}
	/*
