	                  ...
	                  <tr>
	                     ...
	                     <td>
	                        <ul class="icons-list">
	                           ...
	                           <li>
	                              <a onclick="return deleteConfirm();" href="<?php echo ci_site_url();?>user/MessagePanel/deleteInboxMessage/<?php echo ID_encode($msg->id);?>" data-popup="tooltip" title="" data-original-title="Close Ticket"><i class="icon-trash"></i></a>
	                           </li>
	                        </ul>
	                     </td>
	                  </tr>
...
$(document).ready(function(){
  $(".read_msg").click(function(){
     ...
     //alert(msg_id);
     $.ajax({
                   url: "<?php echo ci_site_url();?>user/MessagePanel/readMessage/", // Url to which the request is send
