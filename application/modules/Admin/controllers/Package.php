	...
	*/
	public function editPackage($edit_id=null)
	{
		...
		if(!empty($this->input->post('btn')))
		{
         ...
         $this->db->update("package",array('title'=>$title,"amount"=>$amount,"description"=>$description,'pkg_image'=>$pkg_image,'knowledge_points'=>$knowledge_points,'pv'=>$knowledge_points,'daily_binary_cycle'=>$daily_binary_cycle),array("id"=>$edit_id));
