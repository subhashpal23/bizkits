...
/*
@package admin/teacher_video_tutorials
*/
class Teacher_Video_Tutorials extends Common_Controller 
{
   public function __construct()
   {
		...
		$this->load->model('teacher_video_tutorials_model','tutorials_model');
   }
	   ...
	   if(!empty($this->input->post('btn')))
		{
         ...
         redirect(ci_site_url()."admin/teacher_video_tutorials/editVideo/".ID_encode($id));
		 exit;
		}
		$data['id']=$id;
		...
		//pr($data['video']);
	   _adminLayout("teacher-video-tutorials-mgmt/edit-video",$data);
   }//end method
   public function viewAllVideoList()
   {
	   ...
	   _adminLayout("teacher-video-tutorials-mgmt/view-all-video-list",$data);
   }//end method
   public function viewAllApprovedVideoList()
   {
	   ...
	   $data['all_video']=$all_video;
	   _adminLayout("teacher-video-tutorials-mgmt/view-all-approved-video-list",$data);
   }//end method
   public function viewAllUnapprovedVideoList()
   {
	   ...
	   $data['all_video']=$all_video;
	   _adminLayout("teacher-video-tutorials-mgmt/view-all-unapproved-video-list",$data);
   }//end method
   public function viewAllAssignedVideoList()
   {
	   $data=array();
	   _adminLayout("teacher-video-tutorials-mgmt/view-all-assigned-video-list",$data);
   }//end method
   public function viewAllUnassignedVideoList()
   {
	   $data=array();
	   _adminLayout("teacher-video-tutorials-mgmt/view-all-unassigned-video-list",$data);
   }//end method
   ...
   public function changeVideoStatus($id,$status)
   {
		...
		redirect(ci_site_url().'admin/teacher_video_tutorials/viewAllVideoList');
		exit;
	}
}//end class
?>