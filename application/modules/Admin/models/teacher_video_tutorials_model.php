...
/*
 * @package admin/teacher_video_tutorials_model
*/
class Teacher_Video_Tutorials_Model extends Common_Model
{
  ...
  public function getVideo($id)
  {
    return $this->db->select(array('v.*','vc.name as category_name'))
	 ->join('video_categories as vc','vc.id=v.video_categories_id','left')
	 ->from("video as v")
	 ->where('v.id',$id)
	 ->get()
	 ->row();
  ...
  public function getAllApprovedVideo()
  {
    return $this->db->select(array('v.*','vc.name as category_name'))
	 ->join('video_categories as vc','vc.id=v.video_categories_id','left')
	 ->from("video as v")
	 ->where(array('v.approve_status'=>'1','v.role_type'=>'2'))
	 ->get()
	 ->result();
  }//end method
  public function getAllUnapprovedVideo()
  {
    return $this->db->select(array('v.*','vc.name as category_name'))
	 ->join('video_categories as vc','vc.id=v.video_categories_id','left')
	 ->from("video as v")
	 ->where(array('v.approve_status'=>'0','v.role_type'=>'2'))
	 ->get()
	 ->result();
  }//end method
