               ...
               <tbody>
                  ...
                  <tr>
                     ...
                     <td>
                        <ul class="icons-list">
                           <li>
                              <a onclick="return changeStatusConfirm('<?php echo $member->active_status;?>');" href="<?php echo ci_site_url();?>admin/member/changeStatus/<?php echo ID_encode($member->user_id);?>" data-popup="tooltip" title="" data-original-title="<?php echo $status_change_tooltip;?>"><i class="<?php echo $status_change_icon;?>"></i></a>
                           </li>
                           <li>
