<script type= "text/javascript" src = "<?php echo base_url();?>frontassets/js/countries.js"></script>
            ...
            ?>
                            ...
                            <form class="new-added-form" action="<?php echo ci_site_url();?>Admin/Member/updateNStockistInformation/<?php echo ID_encode($user_id);?>" method='post' enctype='multipart/form-data'>
                            <div class="row">
