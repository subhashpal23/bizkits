    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form id="addForm" method="post" action="<?php echo base_url('Admin/Expert/register'); ?>">
            ...
            <div class="form-group">
                <input type="text" name="username" required="" onblur="check_username(this.value)" id="username"  class="form-control required" placeholder="Username">
            ...
            <div class="form-group">
                <input required="" type="text" id="contact_no"  class="form-control required"  name="contact_no" placeholder="Phone">
                <span id="matchpassword"></span>
            </div>
            
            <div class="form-group mb-30">
                <button type="submit" class="btn btn-primary btn-block hover-up" name="login" value="login">Submit</button>
            </div>
