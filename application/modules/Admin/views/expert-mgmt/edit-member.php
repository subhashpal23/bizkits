            ...
            ?>
                            ...
                            <form class="new-added-form" action="<?php echo ci_site_url();?>Admin/Expert/updatePersonalInformation/<?php echo ID_encode($user_id);?>" method='post' enctype='multipart/form-data'>
                            <div class="row">
                ...
                <!-- Bank settings -->
                                 <div class="card height-auto">
                                    ...
                                    <div class="card-body">
                                       ...
                                       <form class="new-added-form" action="<?php echo site_url();?>Admin/Member/updateUserInformation/<?php echo ID_encode($user_id);?>" method="post">
                                          <div class="form-group">
                                             <div class="row">
                                                <div class="col-md-6">
                                                   <label>Username</label>
                                                   <input type="text" name="username" value="<?php echo $username;?>" placeholder="Enter User Name" class="form-control">
                                                </div>
