               ...
               <div class="page-header">
                  <div class="page-header-content">
                     <div class="page-title">
                        <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Investment Management</span> - Investment Statements</h4>
                     </div>
                  <a class="heading-elements-toggle"><i class="icon-menu"></i></a></div>
                  <div class="breadcrumb-line">
                     <ul class="breadcrumb">
                        <li><a href="<?php echo ci_site_url();?>user"<i class="icon-home2 position-left"></i> Home</a></li>
                        <li class="active">Investment Statements</li>
                     </ul>
					 <ul class="breadcrumb">
                     </ul>
                  </div>
				...
				<?php echo $this->session->flashdata('flash_msg');?>
                 <div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Investment Statements</h5>
									...
									if(!empty($all_statements) && count($all_statements)>0)
									{
										...
										?>
											<tr>
												...
												<td><?php echo $statementObj->user_id;?></td>
