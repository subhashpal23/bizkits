         ...
         <div class="invoice-content">
            ...
            <div class="invoice-price">
               <div class="invoice-price-left">
                  <div class="invoice-price-row">
                     <div class="sub-price">
                        ...
                        <span class="text-inverse"><?php echo currency().''.$info->final_price;?></span>
                     </div>
                     <?php
                     ...
                     <div class="sub-price">
                        ...
                        <span class="text-inverse"><?php 
											...
											echo currency().''.$tfees=$cart_total_tax;?></span>
                     </div>
                     <?php
                     }
                     ?>
                     ...
                     <div class="sub-price">
                        ...
                        <span class="text-inverse"><?php 
											...
											echo currency().''.$tfees=$cart_total_discount;?></span>
                     </div>
                     <?php
                     }
                     ?>
               ...
               <div class="invoice-price-right">
                  <small>TOTAL</small> <span class="f-w-600"><?php echo currency().($info->final_price-$cart_total_discount+$cart_total_tax);?></span>
               </div>
            </div>
            <!-- end invoice-price -->
         </div>
