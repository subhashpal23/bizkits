   ...
   <div class="content">
      ...
      <div class="row">
         <div class="card card-body">
             <form action="<?php echo base_url();?>Admin/Eshop_orders/monthlyOrders" method="post">
                            
                            <div class="col-md-4">
                                <div class="form-group">
                                    <input type="text" name="user_id" class="form-control" placeholder="UserID" value="">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <input type="text" name="fromdate" class="form-control datepicker" placeholder="Username" value="">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
            ...
            <table class="table datatable-responsive table-bordered table-striped table-hover" >
               ...
               <tbody>
                  ...
                  <tr>
                     ...
                     <td>
                         <?php if($order->order_status=='1' && $order->bill){ echo "Confirm Order"; } else
                         {?>
