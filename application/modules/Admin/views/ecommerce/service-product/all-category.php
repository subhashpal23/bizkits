...
<a href="<?php echo site_url().$module_name;?>/ServiceProduct/addNewCategory" class="btn btn-success"><i class="icon-comment-discussion position-left"></i> Add New Category</a>
               ...
               <tbody>
                  ...
                  <tr>
                     ...
                     <td>
                        <ul class="icons-list">
                           <li>
                              <a href="<?php echo site_url().$module_name;?>/ServiceProduct/editCategory/<?php echo ID_encode($cat['id']);?>" data-popup="tooltip" title="" data-original-title="Edit Category"><i class="fa fa-edit"></i></a>
                           </li>
						   <!--
						   <li>
