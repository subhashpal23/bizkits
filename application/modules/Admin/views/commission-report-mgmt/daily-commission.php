   ...
   <div class="page-header page-header-default">
      <div class="page-header-content">
         <div class="page-title">
            <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Commission Report</span> - Daily Income Report</h4>
         </div>
      ...
      <div class="row">
         <div class="panel panel-flat">
            <div class="panel-heading">
               <h5 class="panel-title">Daily Income Report</h5>
               <div class="heading-elements">
                  <ul class="icons-list">
               ...
               <tbody>
                  ...
                  ?>
                     <tr>
						...
						<td><?php echo $income->deposit_type;?></td>
                        <td><?php echo $income->deposit_id;?></td>
      ...
      <div class="row">
         <div class="col-md-6">
            <div class="panel bg-primary">
               <div class="panel-heading">
                  <h6 class="panel-title">Total Daily Income</h6>
               </div>
