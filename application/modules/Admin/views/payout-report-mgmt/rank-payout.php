      ...
      <div class="row">
          <div class="card card-body">
            <div class="card-heading">
               <h5 class="card-title">Rank Payout</h5>
             </div>
             <form class="new-added-form" action="<?php echo ci_site_url();?>Admin/Member/updatePersonalInformation/<?php echo ID_encode($user_id);?>" method='post' enctype='multipart/form-data'>
                               <div class="row">
                                ...
                                <div class="col-xl-3 form-group">
                                    <select name='rank' id='rank' class="form-control">
                                        ...
                                        foreach($rank_list as $key=>$val)
                                        {
                                            ...
                                            echo "<option value='".$val->id."' ".$sel.">".$val->rank_name."</option>";
                                        }
                                        ?>
                                    </select>
                                ...
                                <div class="col-xl-3 form-group">
                                    ...
                                    <a href="javascript:void(0);" onclick="createPayout();">Make New Rank Payout Today</a>
                                </div>
                                <script>
                                    function createPayout()
                                    {
                                        ...
                                        if(rank!='')
                                        {
                                            window.location.href='<?php echo base_url();?>Admin/PayoutReport/createRankPayout/'+rank;
                                        }
                                        else
                                        {
...
function pageopen(type)
{
    ...
    if(type=='search')
    {
        window.location.href='<?php echo base_url();?>Admin/PayoutReport/rankPayout/'+payout;   
    }
    if(type=='export')
    {
        window.location.href='<?php echo base_url();?>Admin/PayoutReport/exportRankPayout/'+payout;   
    }
}//end function
