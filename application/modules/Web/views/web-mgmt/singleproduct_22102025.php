							...
							<div class="row">
								<div class="col-lg-5 col-md-6 col-12">
									<div class="flexslider">
										<ul class="slides">
											<li data-thumb="<?php echo base_url();?>product_images/<?php echo $products->product_image;?>">
											  <img src="<?php echo base_url();?>product_images/<?php echo $products->product_image;?>" alt="woman" />
											</li>
									...
									<div class="product-info-main">
										...
										<div class="product-info-price">
											<div class="price-final">
												<!--<span>$<?php echo $products->price1;?></span>-->
												<div class="price-option">
                                                    <label>
                                                      <input type="radio" name="price" checked value="Basic" data-desc="Basic plan with limited features">
                                                      Basic - $<?php echo $products->price1;?>
                                                    </label>
                                                  </div>
                                                  
                                                  <div class="price-option">
                                                    <label>
                                                      <input type="radio" name="price" value="Economy" data-desc="Standard plan with more features">
                                                      Economy - $<?php echo $products->price2;?>
                                                    </label>
                                                  </div>
                                                  
                                                  <div class="price-option">
                                                    <label>
                                                      <input type="radio" name="price" value="Enterprise" data-desc="Premium plan with all features">
                                                      Enterprise - $<?php echo $products->price3;?>
                                                    </label>
                                                  </div>
												<!--<span class="old-price">$<?php echo $products->price2;?></span>-->
											</div>
										</div>
										<div class="product-add-form">
											<form action="#">
												<div class="quality-button">
													<input class="qty qty-val" type="number" value="1">
												</div>
												<a href="#" onclick="addcartproducts(<?php echo $products->id;?>)">Add to cart</a>
											</form>
										</div>
						...
						<div class="product-info-area mt-80">
							...
							<div class="tab-content">
                                <div class="tab-pane fade show active" id="Details">
                                    <style>
  .valu { display: none; }   /* hide all by default */
  .valu.active { display: block; } /* only active one shows */
</style>

<!-- Descriptions -->
<div class="valu active" id="basic">
  <p><?php echo $products->description; ?></p>
</div>
<div class="valu" id="economy">
  <p><?php echo $products->description2; ?></p>
</div>
<div class="valu" id="enterprise">
  <p><?php echo $products->long_description; ?></p>
</div>

<script>
  const radios = document.querySelectorAll('input[name="price"]');
  const valuDivs = document.querySelectorAll('.valu');

  radios.forEach(radio => {
    radio.addEventListener('change', function() {
      // hide all
      valuDivs.forEach(div => div.classList.remove('active'));
      // show selected
