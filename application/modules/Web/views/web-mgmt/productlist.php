				...
				<div class="col-lg-12">
					<div class="breadcrumbs-menu">
						<ul>
							...
							<li><a href="<?php echo base_url();?>products" class="active">Shop</a></li>
						</ul>
					</div>
				</div>
			</div>
			...
			<div class="row">
						...
						<div class="left-menu mb-30">
							<ul>
							    <?php
							        ...
							        {
							    ?>
								<li><a href="#"><?php echo $val->category_name;?><span>(0)</span></a></li>
								<?php
							        }
								?>
				...
				<div class="col-lg-9 col-md-12 col-12 order-lg-2 order-1">
					<!--<div class="category-image mb-30">
						<a href="#"><img src="<?php echo base_url();?>frontassets/img/banner/32.jpg" alt="banner" /></a>
					</div>-->
					<div class="section-title-5 mb-30">
						<h2>Book</h2>
					</div>
					<div class="toolbar mb-30">
						<div class="shop-tab">
							<div class="tab-3">
								<ul class="nav">
									<li><a href="#th" data-bs-toggle="tab"><i class="fa fa-th-large"></i>Grid</a></li>
									<li><a class="active" href="#list" data-bs-toggle="tab"><i class="fa fa-bars"></i>List</a></li>
								</ul>
							</div>
							<!--<div class="list-page">
								<p>Items 1-9 of 11</p>
										...
										<div class="product-wrapper-content">
											<div class="product-details">
												...
												<div class="product-price">
													<ul>
														<li>$<?php echo $prd->price1;?></li>
														<li class="old-price">$<?php echo $prd->price1;?></li>
													</ul>
												</div>
