                        ...
                        <div class="col-xl-9 text-end d-none d-xl-block">
                            <ul class="tags-list">
                                <?php
                                    ...
                                    ?>
                                <li class="hover-up">
                                    <a href="<?php echo base_url();?>productlist/<?php echo $val->id;?>"><i class="fi-rs-cross mr-10"></i><?php echo $val->category_name;?></a>
                                </li>
                                <?php
                                    }
                                    ?>
                                ...
                                <div class="product-cart-wrap mb-30">
                                    ...
                                    <div class="product-content-wrap">
                                        <div class="product-category">
                                            <a href="<?php echo base_url();?>productlist/<?php echo $val->parent_category_id;?>"><?php echo getCategoryName($val->parent_category_id);?></a>
                                        </div>
                    ...
                    <div class="sidebar-widget widget-category-2 mb-30">
                        ...
                        <ul>
                            ...
                            $category=getCategory();
                                    ...
                                    ?>
                            <li>
                                <a href="<?php echo base_url();?>productlist/<?php echo $val->id;?>"> <img src="assets/imgs/theme/icons/category-1.svg" alt="" /><?php echo $val->category_name;?></a>
                                <span class="count"><?php echo getProductsCount($val->id);?></span>
                            </li>
                            <?php
                                    }
                            ?>
