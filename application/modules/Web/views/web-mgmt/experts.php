                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <div class=" text-center" 
                                                                 ...
                                                                 data-name="<?php echo $val->first_name . ' ' . $val->last_name; ?>"
                                                                 data-email="<?php echo $val->email; ?>"
                                                                 data-image="<?php echo base_url().'uploads/images/'.$image; ?>"
                                                                 data-address="<?php echo $val->address_line1; ?>"
                                                                 data-about="<?php echo htmlspecialchars($val->about ?? 'No information available.', ENT_QUOTES); ?>">
                                                                
                                                                
                                                                   
                                                                
                                                                    <h6 class="card-title mb-1"><?php echo $expert->first_name . ' ' . $expert->last_name; ?></h6>
                                                                    <?php if($expert->job_title): ?>
                                                                        <p class="text-muted small mb-2"><?php echo $expert->job_title; ?></p>
                                                                    <?php endif; ?>
                                                            ...
                                                            <td>
                                                                <button class="btn btn-primary mt-2" onclick="openRequestModal('<?php echo $val->user_id;?>')">
                                                                    Add Request
                                                                </button>
                                                            </td>
                                                        </tr>
