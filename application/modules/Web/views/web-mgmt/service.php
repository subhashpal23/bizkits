            ...
            <div class="row flex-row-reverse" style="transform: none;">
                <div class="col-lg-4-5">
                    <div class="shop-product-fillter">
                        <div class="totall-product">
                            <p>We found <strong class="text-brand"><?php echo getServicesCount();?></strong> items for you!</p>
                        </div>
                    ...
                    <div class="product-list mb-50">
                        ...
                        <div class="product-cart-wrap">
                            ...
                            <div class="product-content-wrap">
                                ...
                                <p class="mt-15 mb-15"><?php echo substr($val->description,0,100);?></p>
                ...
                <div class="theiaStickySidebar" style="padding-top: 0px; padding-bottom: 1px; position: static; transform: none;"><div class="sidebar-widget widget-category-2 mb-30">
                        ...
                        <ul>
                            ...
                            {
                               $category_count=getServiceProductsCount($val->id); 
                               if($category_count)
                               {
                            ?>
                            <li>
