                                    ...
                                    <div class="padding_eight_all bg-white">
                                        ...
                                        <form action="<?php echo base_url();?>Web/login" method="POST">
                                            ...
                                            <div class="login_footer form-group mb-50">
                                                ...
                                                <a class="text-muted" href="<?php echo base_url();?>Web/forgetpassword">Forgot password?</a>

                                            </div>
                                            <div class="form-group">
                                                <button type="submit" class="btn btn-heading btn-block hover-up" name="login" value="btn">Log in</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
