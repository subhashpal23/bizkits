            ...
            <div class="container">
                <div class="home-slide-cover mt-30">
                    <div class="hero-slider-1 style-4 dot-style-1 dot-style-1-position-1">
                        <div class="single-hero-slider single-animation-wrap" style="background-image: url(<?php echo base_url();?>frontassets/imgs/slider/slider-1.png)">
                        ...
                        <div class="single-hero-slider single-animation-wrap" style="background-image: url(<?php echo base_url();?>frontassets/imgs/slider/slider-2.png)">
                            <!--<div class="slider-content">
                                <h1 class="display-2 mb-40">
                                    Fresh Vegetables<br />
                                    Big discount
                        ...
                        <div class="single-hero-slider single-animation-wrap" style="background-image: url(<?php echo base_url();?>frontassets/imgs/slider/slider-3.png)">
                            <!--<div class="slider-content">
                                <h1 class="display-2 mb-40">
                                    Fresh Vegetables<br />
                                    Big discount
                    ...
                    <div class="carausel-10-columns" id="carausel-10-columns">
                        <div class="card-2 bg-9 wow animate__animated animate__fadeInUp" data-wow-delay=".1s">
                            <figure class="img-hover-scale overflow-hidden">
                                <a href="shop-grid-right.html"><img src="<?php echo base_url();?>frontassets/imgs/shop/cat-13.png" alt="" /></a>
                            </figure>
                        ...
                        <div class="card-2 bg-10 wow animate__animated animate__fadeInUp" data-wow-delay=".2s">
                            <figure class="img-hover-scale overflow-hidden">
                                <a href="shop-grid-right.html"><img src="<?php echo base_url();?>frontassets/imgs/shop/cat-12.png" alt="" /></a>
                            </figure>
                        ...
                        <div class="card-2 bg-11 wow animate__animated animate__fadeInUp" data-wow-delay=".3s">
                            <figure class="img-hover-scale overflow-hidden">
                                <a href="shop-grid-right.html"><img src="<?php echo base_url();?>frontassets/imgs/shop/cat-11.png" alt="" /></a>
                            </figure>
                        ...
                        <div class="card-2 bg-12 wow animate__animated animate__fadeInUp" data-wow-delay=".4s">
                            <figure class="img-hover-scale overflow-hidden">
                                <a href="shop-grid-right.html"><img src="<?php echo base_url();?>frontassets/imgs/shop/cat-9.png" alt="" /></a>
                            </figure>
                        ...
                        <div class="card-2 bg-13 wow animate__animated animate__fadeInUp" data-wow-delay=".5s">
                            <figure class="img-hover-scale overflow-hidden">
                                <a href="shop-grid-right.html"><img src="<?php echo base_url();?>frontassets/imgs/shop/cat-3.png" alt="" /></a>
                            </figure>
                        ...
                        <div class="card-2 bg-14 wow animate__animated animate__fadeInUp" data-wow-delay=".6s">
                            <figure class="img-hover-scale overflow-hidden">
                                <a href="shop-grid-right.html"><img src="<?php echo base_url();?>frontassets/imgs/shop/cat-1.png" alt="" /></a>
                            </figure>
                        ...
                        <div class="card-2 bg-15 wow animate__animated animate__fadeInUp" data-wow-delay=".7s">
                            <figure class="img-hover-scale overflow-hidden">
                                <a href="shop-grid-right.html"><img src="<?php echo base_url();?>frontassets/imgs/shop/cat-2.png" alt="" /></a>
                            </figure>
                        ...
                        <div class="card-2 bg-12 wow animate__animated animate__fadeInUp" data-wow-delay=".8s">
                            <figure class="img-hover-scale overflow-hidden">
                                <a href="shop-grid-right.html"><img src="<?php echo base_url();?>frontassets/imgs/shop/cat-4.png" alt="" /></a>
                            </figure>
                        ...
                        <div class="card-2 bg-10 wow animate__animated animate__fadeInUp" data-wow-delay=".9s">
                            <figure class="img-hover-scale overflow-hidden">
                                <a href="shop-grid-right.html"><img src="<?php echo base_url();?>frontassets/imgs/shop/cat-5.png" alt="" /></a>
                            </figure>
                        ...
                        <div class="card-2 bg-12 wow animate__animated animate__fadeInUp" data-wow-delay="1s">
                            <figure class="img-hover-scale overflow-hidden">
                                <a href="shop-grid-right.html"><img src="<?php echo base_url();?>frontassets/imgs/shop/cat-14.png" alt="" /></a>
                            </figure>
                        ...
                        <div class="card-2 bg-11 wow animate__animated animate__fadeInUp" data-wow-delay="0s">
                            <figure class="img-hover-scale overflow-hidden">
                                <a href="shop-grid-right.html"><img src="<?php echo base_url();?>frontassets/imgs/shop/cat-15.png" alt="" /></a>
                            </figure>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="banner-img wow animate__animated animate__fadeInUp" data-wow-delay="0">
                            <img src="<?php echo base_url();?>frontassets/imgs/banner/banner-1.png" alt="" />
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="banner-img wow animate__animated animate__fadeInUp" data-wow-delay=".2s">
                            <img src="<?php echo base_url();?>frontassets/imgs/banner/banner-2.png" alt="" />
                            <div class="banner-text">
                                <h4>
                    ...
                    <div class="col-lg-4 d-md-none d-lg-flex">
                        <div class="banner-img mb-sm-0 wow animate__animated animate__fadeInUp" data-wow-delay=".4s">
                            <img src="<?php echo base_url();?>frontassets/imgs/banner/banner-3.png" alt="" />
                            <div class="banner-text">
                    ...
                    <div class="tab-pane fade show active" id="tab-one" role="tabpanel" aria-labelledby="tab-one">
                        <div class="row product-grid-4">
                            ...
                            foreach($products as $key=>$val)
                            {
                                ...
                                {
                                    $new_price=$val->new_price-((int)$val->new_price*(int)$val->discount)/100;
                                    ...
                                    <div class="product-cart-wrap mb-30 wow animate__animated animate__fadeIn" data-wow-delay=".1s">
                                        <div class="product-img-action-wrap">
                                            <div class="product-img product-img-zoom">
                                                <a href="<?php echo base_url();?>product/<?php echo $val->id;?>">
                                            ...
                                            <div class="product-badges product-badges-position product-badges-mrg">
                                                <span class="hot"><?php echo $discount;?>%</span>
                                            </div>
                                            <?php
                                            }
                                            ?>
                                        ...
                                        <div class="product-content-wrap">
                                            <div class="product-category">
                                                <a href="<?php echo base_url();?>product/<?php echo $val->id;?>"><?php echo getCategoryName($val->parent_category_id);?></a>
                                            </div>
                                            <h2><a href="<?php echo base_url();?>product/<?php echo $val->id;?>"><?php echo $val->title;?></a></h2>
                                            ...
                                            ?>
                                                ...
                                                <div class="add-cart">
                                                    <a class="add" href="javscript:void(0);" onclick="addtocartproducts(<?php echo $val->id;?>)"><i class="fi-rs-shopping-cart mr-5"></i>Add </a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="shop-product-right.html">
                                                <img class="default-img" src="<?php echo base_url();?>frontassets/imgs/shop/product-10-1.jpg" alt="" />
                                                <img class="hover-img" src="<?php echo base_url();?>frontassets/imgs/shop/product-10-2.jpg" alt="" />
                                            </a>
                                        </div>
                                        <div class="product-action-1">
                                            <a aria-label="Add To Wishlist" class="action-btn" href="shop-wishlist.html"><i class="fi-rs-heart"></i></a>
