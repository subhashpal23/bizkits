  ...
  <?php 
     ...
     $sponsor_id=(!empty($registration_info['sponsor_and_account_info']['ref_user_name']))?$registration_info['sponsor_and_account_info']['ref_user_name']:123456;
  ...
  <!-- breadcrumb-banner-area -->
    <div class="breadcrumb-banner-area bg-img-2 bg-opacity-2 ptb-30">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="col-md-12">
             <!-- <div class="sign-logo text-center">
              ...
              <div class="sign-content">
                <p class="message-register">Register For School</p>
              </div>
                <form name="registration" method="post" action="<?php echo site_url();?>Web/listaschool">
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                          <input type="text" class="form-control" name="first_name" value="<?php echo $first_name;?>" placeholder="Please enter school name" required="">&nbsp;&nbsp;&nbsp;&nbsp;
                          <span id="valid_firstname"></span>
                        </div>
                        <div class="form-group">
                          <input type="tel" class="form-control" name="phone" value="<?php echo $contact_no;?>" placeholder="Please enter school phone number" required="">&nbsp;&nbsp;&nbsp;&nbsp;
                          <span id="valid_phone"></span>
                        </div>
                        <div class="form-group">
                          <textarea  class="form-control" name="address" placeholder="Please enter school address"><?php echo $address;?></textarea>&nbsp;&nbsp;&nbsp;&nbsp;
                          <span id="valid_phone"></span>
                        </div>
                        <div class="form-group">
                          <input type="text" class="form-control" name="contact_person" value="<?php echo $contact_no;?>" placeholder="Contact Person" required="">&nbsp;&nbsp;&nbsp;&nbsp;
                          <span id="valid_contactperson"></span>
                        </div>
                        <div class="form-group">
                          <input type="text" class="form-control" name="contact_person_email" value="<?php echo $contact_no;?>" placeholder="Contact Person Email" required="">&nbsp;&nbsp;&nbsp;&nbsp;
                          <span id="valid_contactpersonemail"></span>
                        </div>
                        <div class="form-group">
                          <input type="text" class="form-control" name="contact_person_phone" value="<?php echo $contact_no;?>" placeholder="Contact Person Phone" required="">&nbsp;&nbsp;&nbsp;&nbsp;
                          <span id="valid_contactpersonphone"></span>
                        </div>
                    ...
                    <button type="submit" name="btn" id="btn" value="submit" class="btn btn-primary">List A School</button>
                  </form>
