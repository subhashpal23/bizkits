         ...
         <div class="page_header_default style_one ">
            <div class="parallax_cover">
               <img src="<?php echo base_url();?>frontassets/images/page-header-default.jpg"  alt="bg_image" class="cover-parallax">
            </div>
                        ...
                        <div class="about_content position-relative z_99">
                           <div class="title_all_box style_one text-left  dark_color">
                              <div class="title_sections">
                                 <div class="before_title">OUR PRODUCTS </div>
                                <!-- <h2>Welcome to i3 Empire, where we've redefined the paradigm of health and wealth.
</h2>-->
                              </div>
                           </div>
                           <!--===============spacing==============-->
                           ...
                           <div class="description_box">
                              <p>Unlock the power of nature with our organic and meticulously crafted products. 
At i3 Empire, we believe in the essence of simplicity and purity, offering you a range of products made exclusively from natural ingredients for your overall well-being.
</p>
                           </div>
                           <!--===============spacing==============-->
...
<div class="description_box">
    <h2>WHY CHOOSE i3 EMPIRE PRODUCTS?
</h2>
    <ol>
         <li>
        Organic Excellence
        Our commitment to your well-being starts with sourcing the finest organic ingredients. Experience the purity of nature in every product, free from synthetic additives and harmful chemicals.
        </li>
        <li>
        Meticulous Craftsmanship
        Each product is carefully crafted to ensure optimal effectiveness. Our dedication to quality means you can trust i3 Empire for products that meet the highest standards of excellence.
        </li>
        <li>
        Nature's Goodness Unleashed
        Immerse yourself in the goodness of nature. Our products harness the power of natural ingredients, providing you with a holistic approach to wellness that aligns with your healthy lifestyle.
        </li>
        <li>
        Transparency Matters
        We believe in transparency. Every ingredient is listed clearly, so you know exactly what you're putting on and in your body. No hidden surprises, just pure, natural goodness.
        (Images and health benefits of our products here)
        </li>
    </ol>
<p>
Explore the world of i3 Empire products and elevate your well-being with the simplicity and authenticity of nature. Your journey to a healthier and more vibrant you begins here.
</p>
                           </div>
                           <div class="theme_btn_all color_one">
                              <a href="#" target="_blank" rel="nofollow" class="theme-btn five">Join Us<i
                  ...
                  <div class="row">
                     <div class="col-xl-4 col-lg-6 col-md-12 col-sm-12 col-xs-12">
                        <div class="simple_image_boxes parallax_cover height_264px">
                              <img src="<?php echo base_url();?>frontassets/images/icon-img-ab-1.jpg" class="simp_img cover-parallax" alt="image">
                        </div>
                        <!--===============spacing==============-->
                        <div class="pd_bottom_20"></div>
                        <!--===============spacing==============-->
                     ...
                     <div class="col-xl-4 col-lg-6 col-md-12 col-sm-12 col-xs-12 mt-4 mt-lg-4 mt-xl-0">
                        ...
                        <div class="simple_image_boxes  height_264px">
                           <img src="<?php echo base_url();?>frontassets/images/icon-img-ab-2.jpg" class="simp_img img-fluid" alt="image">
                        </div>
                     </div>
                  </div>
               </div>
                              ...
                              <div class="swiper-slide">
                                 <div class="time_line_box">
                                    <div class="time_inner">
                                       ...
                                       <div class="image">
                                          <img src="<?php echo base_url();?>frontassets/images/projects/project-3-img.jpg" alt="img">
                                       </div>
                                    </div>
                                 </div>
                              </div>
                              <div class="swiper-slide">
                                 <div class="time_line_box">
                                    <div class="time_inner">
                                       ...
                                       <div class="image">
                                          <img src="<?php echo base_url();?>frontassets/images/projects/project-5-img.jpg" alt="img">
                                       </div>
                                    </div>
                                 </div>
                              </div>
                              <div class="swiper-slide">
                                 <div class="time_line_box">
                                    <div class="time_inner">
                                       ...
                                       <div class="image">
                                          <img src="<?php echo base_url();?>frontassets/images/service/service-image-4.jpg" alt="img">
                                       </div>
                                    </div>
                                 </div>
                              </div>
                              <div class="swiper-slide">
                                 <div class="time_line_box">
                                    <div class="time_inner">
                                       ...
                                       <div class="image">
                                          <img src="<?php echo base_url();?>frontassets/images/blog/blog-image-8.jpg" alt="img">
                                       </div>
                                    </div>
                                 </div>
                              </div>
            ...
            <!---timeline---->
            <!---tab---->
               <section class="tab-section bg_op_1" style="background-image:url(<?php echo base_url();?>frontassets/images/tab-sec-bg.jpg);">
                  <!--===============spacing==============-->
                                    ...
                                    <div class="s_tabs_content">
                                       <div class="s_tab fade active-tab show" id="tabtabone">
                                          <div class="tab_content one"
                                             style="background-image:url(<?php echo base_url();?>frontassets/images/tab-image.jpg)">
                                             <div class="content_image">
                                                ...
                                                <a href="#" target="_blank" rel="nofollow" class="rd_more">Read More <i
                                                      class="icon-right-arrow"></i></a>
                                             </div>
                                          </div>
                                       </div>
                                       <div class="s_tab fade" id="tabtabthree">
                                          <div class="tab_content one"
                                             style="background-image:url(<?php echo base_url();?>frontassets/images/blog/blog-image-8.jpg)">
                                             <div class="content_image">
                                                <h6>Why Creote</h6>
                                       ...
                                       <div class="s_tab fade" id="tabtabthree">
                                          <div class="tab_content one"
                                             style="background-image:url(<?php echo base_url();?>frontassets/images/banner-five-bg.jpg)">
                                             <div class="content_image">
                                                <h6>Why Creote</h6>
                                       ...
                                       <div class="s_tab fade" id="tabtabfour">
                                          <div class="tab_content one"
                                             style="background-image:url(<?php echo base_url();?>frontassets/images/home-4-about-1.jpg)">
                                             <div class="content_image">
                                                <h6>Why Creote</h6>
                                       ...
                                       <div class="s_tab fade" id="tabtabfive">
                                          <div class="tab_content one"
                                             style="background-image:url(<?php echo base_url();?>frontassets/images/image-about-ls.jpg)">
                                             <div class="content_image">
                                                <h6>Why Creote</h6>
                  ...
                  <div class="row">
                        ...
                        <div class="team_box style_one">
                           <div class="team_box_outer">
                              <div class="member_image">
                                 <img src="<?php echo base_url();?>frontassets/images/team/team-1.jpg" alt="team image" />
                              </div>
                     ...
                     <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
                        <div class="team_box style_one">
                           <div class="team_box_outer">
                              <div class="member_image">
                                 <img src="<?php echo base_url();?>frontassets/images/team/team-2.jpg" alt="team image" />
                              </div>
                              <div class="about_member">
                                 <div class="share_media">
                                    <ul class="first">
                     ...
                     <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
                        <div class="team_box style_one">
                           <div class="team_box_outer">
                              <div class="member_image">
                                 <img src="<?php echo base_url();?>frontassets/images/team/team-3.png" alt="team image" />
                              </div>
                              <div class="about_member">
                                 <div class="share_media">
                                    <ul class="first">
