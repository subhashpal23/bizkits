							...
							<div class="row">
								<div class="col-lg-6 col-xs-12 col-sm-6 col-md-6">
									...
									<div class="f-logo">
											...
											<a target="_blank" href="#"><img src="<?php echo base_url();?>affiliateassets/images/inter.png" alt="s chand group"  class="dnd_covergia">
											</a>
										</div>
	                         ...
	                         <input type="button" class="submit-btn" value="Subscribe now"  name="">
										...
										<div class="social-media m-t-30">
											<ul class="list-inline">
												<li><a rel="nofollow" target="_blank" href="#"><img src="<?php echo base_url();?>affiliateassets/images/yt.png"></a></li>
												<li><a rel="nofollow" target="_blank" href="#"><img src="<?php echo base_url();?>affiliateassets/images/fb.png"></a></li>
												<li><a rel="nofollow" target="_blank" href="#"><img src="<?php echo base_url();?>affiliateassets/images/tw.png"></a></li>
												<li><a rel="nofollow" target="_blank" href="#"><img src="<?php echo base_url();?>affiliateassets/images/li.png"></a></li>
												<li><a rel="nofollow" target="_blank" href="#"><img src="<?php echo base_url();?>affiliateassets/images/in.png"></a></li>
											</ul>
										</div>
									</div>
								</div>
...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/js/bootstrap.min.js"></script>				
		...
		<script defer src="<?php echo base_url();?>affiliateassets/js/jquery.fancybox.min.js"></script>
		<!-- Include all compiled plugins (below), or include individual files as needed -->
		<script defer src="<?php echo base_url();?>affiliateassets/js/main.js"></script>
			<style>
a.headcfd {
    min-width: 100%;
}
