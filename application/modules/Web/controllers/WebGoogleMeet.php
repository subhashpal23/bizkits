...
class WebGoogleMeet extends CI_Controller {
    ...
    private function getClient() {
        ...
        $client->setRedirectUri('http://localhost/bizkits/googlemeet/callback');
	...
	public function callback() {
		...
		redirect('googlemeet/createMeeting');
	}
