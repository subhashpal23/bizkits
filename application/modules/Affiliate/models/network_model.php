...
class Network_Model extends Common_Model
{
  ...
  public function __construct()
    ...
    */
    public function getBinaryTreeChildElement($rootUserId,$leg)
    {
        return $this->db->select("*")->from('level_income_binary')->where(array('income_id'=>$rootUserId,'level'=>'1','leg'=>$leg))->get()->result();
    }
