                     ...
                     <tr>
                        ...
                        <td>
                           <ul class="icons-list">
                              ...
                              <li>
                                 <a onclick="return deleteConfirm();" href="<?php echo ci_site_url();?>user/MessagePanel/deleteSentMessage/<?php echo ID_encode($msg->id);?>" data-popup="tooltip" title="" data-original-title="Close Message"><i class="icon-trash"></i></a>
                              </li>
                           </ul>
                        </td>
                     </tr>                  
