							...
							<!-- Basic layout-->
								...
								<div class="card-body">
									...
									<a class="heading-elements-toggle"><i class="icon-menu"></i></a></div>
										...
										$transaction_password=(!empty($transaction_password))?$transaction_password:'';
										$pkg_amount=(!empty($user->pkg_amount))?$user->pkg_amount:'';
										$active_status=(!empty($user->active_status))?$user->active_status:'';
										$currency=currency();
										//pr($user);
                                        if($active_status=='')
                                        {
										...
										<!--<form method="post" class="form-horizontal">-->								
											<div class="card-body">
											    <div class="form-group">
													...
													<div class="col-lg-9">
														<?php echo $currency.$pkg_amount;?>
													</div>
												</div>
												<div class="form-group">
													<label class="col-lg-3 control-label">Enter Transaction Password:</label>
													<div class="col-lg-9">
														<input value="<?php echo set_value('transaction_password',$transaction_password);?>" id="transaction_password" type="password" name="transaction_password" class="form-control" placeholder="Transaction Password">
														<span id="valid_transaction_password" style="color:red;font-weight:bold;display:none"></span>

														<?php echo form_error('transaction_password','<span id="valid_transaction_password" style="color:red;font-weight:bold;">', '</span>');?>
													</div>
												</div>
												...
												<div class="text-left">
													<button id="submitBtn" type="submit" name="btn" value="submit" class="btn-fill-lg btn-gradient-yellow btn-hover-bluedark">Activate Account</button>
												</div>
											</div>
										<!--</form>-->
										<?php echo form_close();
