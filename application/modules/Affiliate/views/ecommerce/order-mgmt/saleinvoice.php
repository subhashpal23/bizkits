         ...
         <div class="invoice-header">
            <div class="invoice-from">
               ...
               <address class="m-t-5 m-b-5">
                  <strong class="text-inverse"><?php echo $userinfo->first_name.' '.$userinfo->last_name;?></strong><br>
                  <?php echo $userinfo->address_line1.' '.$userinfo->city;?>, <br>
                  <?php echo $userinfo->state.' '.$userinfo->zipcode;?><br>
                  Phone: <?php echo $userinfo->contact_no;?><br>
            ...
            <div class="invoice-to">
               ...
               <address class="m-t-5 m-b-5">
                   ...
                   //pr($userinfo);
                   ?>
                  <strong class="text-inverse"><?php echo $binfo->category_name;?></strong><br>
                  ...
                  <div class="invoice-price-row">
                     ...
                     <div class="sub-price">
                        ...
                        <span class="text-inverse"><?php 
											$tfees='0.30';
											echo currency().''.$tfees=$info->discount;?></span>
                     </div>
                     
                  </div>
               </div>
               <div class="invoice-price-right">
                  <small>TOTAL</small> <span class="f-w-600"><?php echo currency().($info->final_price-$info->discount);?></span>
               </div>
            </div>
            <!-- end invoice-price -->
         </div>
