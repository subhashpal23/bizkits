...
<a href="<?php echo site_url().$module_name;?>/Eshop/addNewCategory" class="fa fa-plus" style="float:right"><i class="icon-comment-discussion position-left"></i> Add New Customer</a>
