                    ...
                    <div class="card card-body ">
                        <div class="card no-margin">
                            ...
                            <div class="card-footer">
                              ...
                              <a href="javascript:void(0)" onclick="addcartvalue(<?php echo $product['id'];?>)" class="btn-fill-lg btn-gradient-yellow btn-hover-bluedark">Add To Cart</a>
...
<script>
    function addcartvalue(id)
    {
        ...
        var url="<?php echo site_url();?>Affiliate/Cart/addToCartRepurchase/<?php echo $product['id'];?>/eshop/"+qty;
