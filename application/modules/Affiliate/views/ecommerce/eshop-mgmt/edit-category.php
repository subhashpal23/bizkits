   ...
   <div class="content">
										...
										<input type='hidden' value="<?php echo $category_data['id']; ?>" name='hidid' />
											<div class="card-body">
												...
												<div class="form-group">
													...
													<div class="col-lg-9">
						<input type="text" name="category_name" value="<?php echo $category_data['category_name']; ?>" required class="form-control" placeholder="Customer Name">
													</div>
												</div>
     ...
     <button type="submit" name="btn" value="updateNewcategory" class="btn-fill-lg btn-gradient-yellow btn-hover-bluedark">Update <i class="icon-arrow-right14 position-right"></i></button>
												</div>
											</div>
										<!--</form>-->
										<?php echo form_close();?>
