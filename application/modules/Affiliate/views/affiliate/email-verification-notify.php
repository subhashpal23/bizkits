        ...
        <div class="row justify-content-md-center">
          <div class="col-lg-12">
            <div class="card card-hero card-royal animated fadeInUp animation-delay-7">
                      ...
                      <div class="card-body">
                        <div class="row">
                           <p>Dear User. Thanks for your Registration. A Verification Email is sent to your registered email id. Please Verify your account. </p>
                           <p>If you can't find email in Inbox Please check your SPAM Folder.  </p>
                           <p>Email Verification Link will Expire In 20 Min Please Verify your email before your link get expired. </p>
                        </div>
                      </div>
            </div>
          </div>
