                   ...
                   <form action="<?php echo site_url();?>user/auth/frontUserLogin" class="sky-form" method="post" autocomplete="off">
                        ...
                        <?php echo $this->session->flashdata('res');?>
								...
								<?php $rand=substr(rand(),0,4); ?>
                                 ...
                                 <span><a onclick="return captch()" href="#">Reload</a></span>
								</td>
								</tr>
								<tr>
								<td>
								 <input type="text" class="form-control" required="" name="chk" id="chk" Placeholder="Please enter above captcha code!">
												<span id="valid_captcha" style="color:red;font-weight:bold;"></span>
							   </td>
								</tr>
								</table>
								 ...
								 <div class="row">                                    <section class="col col-6">                                       <label class="input">										 <a href='<?php echo site_url();?>front/forgot' />Forgot Password?</a>                                        </label>                                    </section>                                 </div>
                              </fieldset>
							  <footer>								<a href='<?php echo site_url();?>front/register' />Register Now?</a>
...
$(document).ready(function(){
  ...
  $("#btn1").click(function(){
        ...
        if($("#usernamee").val()=="")
		 ...
		 if($("#chk").val()=='')
			 {
				 $("#valid_captcha").text('Please enter captch code!');
				 return false;
			 }
			if($("#chk").val()=='')
			 {
			 ...
			 if($("#chk").val()!=$("#ran").val())
			 {
				 $("#valid_captcha").text('Please enter valid captch code!');
				 return false;
			 }
...
<style type="text/css">
   ...
   {
   width:60px; 
   background-image:url(<?php echo site_url();?>images/cat.png); 
   font-size:20px; 
   border: 1px solid;
   }
   .color
