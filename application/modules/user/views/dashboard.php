      ...
      <div class="panel panel-body bg-success-400 has-bg-image">
         <div class="media no-margin">
            <div class="media-body">
               <h3 class="no-margin"><?php echo currency()." ".$binary_commission;?></h3>
               <span class="text-uppercase text-size-mini">My Binary Income</span>
            </div>
      ...
      <div class="panel panel-body bg-info-400 has-bg-image">
         <div class="media no-margin">
            <div class="media-body">
               ...
               <span class="text-uppercase text-size-mini">My Level Income</span>
            </div>
            <div class="media-right media-middle">
               <i class="icon-coins icon-2x"></i>
            </div>
