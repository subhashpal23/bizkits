                    ...
                    <div class="col-xl-12 col-sm-6 col-12">
                        <div class="card height-auto">
                            <div class="card-body">
                                <div class="heading-layout1">
                                    <div class="item-title">
                                        <h3>School Referral Link</h3>
                                    </div>
                                    
                                </div>
                        			<input type='text' style='width:65%'  value='<?php echo $referral_school_link;?>' class='form-control btn btn-primary' id='ref1'/>
                        			<a href="javascript:void();" id='copyy1' onclick='myFunction1()' class='btn btn-success'>Copy Referral Link</a>
                            </div>
                        </div>
                    </div>
                </div>
