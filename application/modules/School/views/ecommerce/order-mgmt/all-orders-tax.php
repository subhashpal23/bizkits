            ...
            <table class="table datatable-responsive table-bordered table-striped table-hover" >
               ...
               <tbody>
                  ...
                  <tr>
                    ...
                    <td><?php $json=json_decode($order->order_details);
                    //pr($json);
                    foreach($json as $details)
					{
					  $details->product_id;
					  $taxper=$callback_name->getProductTax($details->product_id,$buyer_type,$order->order_id);
					  echo $taxper;
					  $price=$order->final_bv/(1+$taxper/100);
					  $tax=$price*$taxper/100;
					}
                    ?></td>
