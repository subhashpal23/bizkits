                     ...
                     <ul class="icons-list">
                        <li class="dropdown">
                           ...
                           <ul class="dropdown-menu dropdown-menu-right">
                              ...
                              {
                              ?>
                              <li><a title="click to Publish" href="<?php echo ci_site_url();?>admin/MarketingTools/changeStatus/<?php echo ID_encode($image->id);?>/1"><i class="icon-eye"></i> Publish</a></li>
                              <?php    
                              }
                              else 
                              {
                              ?>
                              <li><a title="click to Unpublish" href="<?php echo ci_site_url();?>admin/MarketingTools/changeStatus/<?php echo ID_encode($image->id);?>/0"><i class="icon-eye-blocked"></i> Unpublished</a></li>
                              <?php    
                              }
                              ?>
                              <li><a href="<?php echo ci_site_url();?>admin/MarketingTools/deleteImage/<?php echo ID_encode($image->id);?>"><i class="icon-bin"></i> Delete</a></li>
                           </ul>
                        </li>
                     </ul>
                  </td>
