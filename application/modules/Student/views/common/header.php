                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <div class="item-content">
                                <ul class="settings-list">
                                    ...
                                    <li><a href="<?php echo base_url();?>Student/Auth/logout"><i class="flaticon-turn-off"></i>Log Out</a></li>
                                </ul>
                            </div>
                        </div>
                    </li>
                    ...
                    <ul class="nav nav-sidebar-menu sidebar-toggle-view">
                        ...
                        <li class="nav-item sidebar-nav-item">
                            ...
                            <ul class="nav sub-group-menu">
                                <li class="nav-item">
                                    <a href="<?php echo base_url();?>Student/Fees/feeList" class="nav-link"><i class="fas fa-angle-right"></i>Fees List</a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?php echo base_url();?>Student/Fees/payFees" class="nav-link"><i
                                            class="fas fa-angle-right"></i>Add Fees</a>
                                </li>
                            </ul>
                        </li>
                        
                        <li class="nav-item sidebar-nav-item">
                          <a href="#" class="nav-link"><i class="flaticon-multiple-users-silhouette"></i><span>Study Material</span></a>
                          <ul class="nav sub-group-menu">
        				    <li class="nav-item"><a href="<?php echo site_url().$moduleName;?>/Eshop/" class="nav-link">
        				        <i class="fas fa-angle-right"></i> <span>Eshop Dashboard</span></a></li>
        					<li class="nav-item"><a href="<?php echo site_url().$moduleName;?>/Eshop/allProductList" class="nav-link">
        					    <i class="fas fa-angle-right"></i> <span>Products</span></a></li>
                          </ul>
                        </li>
                       <li  class="nav-item sidebar-nav-item">
