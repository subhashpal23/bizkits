   ...
   <div class="page-header">
      <div class="page-header-content">
         <div class="page-title">
            <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Rank Knowledge Point Report</span> - Right Knowledge Point</h4>
         </div>
      ...
      <div class="breadcrumb-line">
         <ul class="breadcrumb">
            ...
            <li class="active">Right Knowledge Point</li>
         </ul>
         <ul class="breadcrumb">
         </ul>
      </div>
               ...
               <div class="row">
                 <div class="panel panel-flat">
                     <div class="panel-heading">
                        <h5 class="panel-title">Right Knowledge Point</h5>
                     ...
                     <table class="table">
						...
						<tr>
                           ...
                           <td><?php echo get_user_name($point->downline_id);?></td>
