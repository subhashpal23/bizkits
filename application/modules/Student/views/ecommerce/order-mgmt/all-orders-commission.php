      ...
      <div class="row">
         <div class="panel panel-flat">
            ...
            <div class="panel-body">
                <form method="post" action="<?php echo site_url().$module_name;?>/eshop_orders/allOrdersCommission">
                <div class="col-md-6"><input type="text" name="orderid" class="form-control" value="<?php echo $order_id;?>" placeholder="Enter Order ID"></div>
                <div class="col-6"><button type="submit" class="btn btn-success">Search</button></div>
                </form>
            </div>
            <?php 
            ...
            <?php    
               ...
               ?>
               <?php if(!empty($all_orders) && count($all_orders)>0):?>
            <table class="table datatable-responsive table-bordered table-striped table-hover" >
               ...
               <tbody>
                  ...
                  <tr>
                    ...
                    <td><?php echo $order->amount.' '.currency();?></td>
