                    ...
                    <td>0%</td>
                     ...
                     <?php
                      ...
                      else
                      {
                          ...
                          <td><?php echo $sno;?></td>
                     <td><?php echo $order->order_id;?></td>
                     <td><?php echo $order->order_from;?></td>
                     ...
                     <td><?php echo $order->order_date;?></td>
                     <td><?php echo $order->confirm_date;?></td>
                     <td><span class='btn btn-<?php echo $color; ?>' ><?php echo $status;?></span></td>
                     <td>
                         <?php if($order->order_status=='1'){ echo "Order Confirmed"; } else
                         {?>
                        <select class="form-control myclass change_status_stockist" order_id="<?php echo $order->order_id;?>">
                           <option value="0" <?php if($order->order_status=='0'){ echo "selected"; } ?> >Order Placed</option>
                           <option value="1" <?php if($order->order_status=='1'){ echo "selected"; } ?>>Confirm Order</option>
                        </select>
                        <?php
                         }
                        ?>
                     ...
                     <td>
                        <a href="<?php echo base_url();?>Affiliate/Eshop_Orders/invoice/<?php echo $order->order_id;?>"  order_id="<?php echo $order->order_id; ?>">
                        <i class="fa fa-eye"></i>
                        </a>
                     </td>
                          <?php
