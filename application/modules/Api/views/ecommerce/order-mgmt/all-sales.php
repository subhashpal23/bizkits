<div class="dashboard-content-one">
         ...
         <div class="card height-auto">
            ...
            <div class="card-heading">
                <a href="<?php echo site_url().$module_name;?>/Eshop/addNewSale" class="fa fa-plus" style="float:right"><i class="icon-comment-discussion position-left"></i> New Sale</a>
               ...
               <tbody>
                  ...
                  <tr>
                    ...
                    <td>0%</td>
                     ...
                     <td><?php echo $order->discount.' '.currency();?></td>
                     <td><?php echo ($order->final_price-$order->discount).' '.currency();?></td>
                     ...
                     <td>
                        <a href="<?php echo base_url();?>Affiliate/Eshop_Orders/saleinvoice/<?php echo $order->order_id;?>"  order_id="<?php echo $order->order_id; ?>">
                        <i class="fa fa-eye"></i>
                        </a>
                     </td>
                          <?php
