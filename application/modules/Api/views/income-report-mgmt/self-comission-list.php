                                 ...
                                 <?php 
                                  ...
                                  if(!empty($direct_referral_income) && count($direct_referral_income)>0)
                                  {
                                     ...
                                     foreach ($direct_referral_income as $income) 
                                     {
                                      ...
                                      if($income->level==0)
                                      {
                                          $summary="Personal ".$income->ttype." From ".$fromusername;
                                      }
                                      else
                                      {
                                          $summary="Unilevel ".$income->ttype." From ".$fromusername;
                                      }
                                      ...
                                      $status=($income->status==1)?"Credit":"Debit";
										...
										$signp=($income->payment_method==1)?"-":"+";
										$colorp=($income->payment_method==1)?"red":"green";
										$statusp=($income->payment_method==1)?"Pending":"Paid";
                                  ?>
                                     <tr>
                                        <td><?php echo $sno;?></td>
                                        ...
                                        <td style="color:<?php echo $colorp;?>"><span class="label label-success"><?php echo $statusp;?></span></td>
