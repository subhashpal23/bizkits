   ...
   <div class="page-header">
      <div class="page-header-content">
         <div class="page-title">
            <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Income Report Management</span> - Indirect Referral Bonus</h4>
         </div>
      ...
      <div class="breadcrumb-line">
         <ul class="breadcrumb">
            ...
            <li class="active">Indirect Referral Bonus</li>
         </ul>
         <ul class="breadcrumb">
         </ul>
      </div>
      ...
      <div class="row">
         <div class="panel panel-flat">
            <div class="panel-heading">
               <h5 class="panel-title">Indirect Referral Bonus</h5>
               ...
               <tbody>
                  ...
                  ?>
                     <tr>
						...
						<td>Indirect Referral Bonus of level <?php echo $income->level;?>  for package <?php echo get_package_name($income->pkg_id);?></td>
