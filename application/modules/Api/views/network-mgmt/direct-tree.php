                ...
                ?>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="genealogy-body" style="overflow: visible;">
                            <span>Level <?php echo $level;?> Of User:<?php echo $main_username;?></span>
   <div class="genealogy_tree_view_sec" style="overflow: hidden; user-select: none; touch-action: none;">
      <div class="genealogy-tree" id="tree-view-head" data-height="240px" style="cursor: move; user-select: none; touch-action: none; transform-origin: 50% 50%; transition: transform 200ms ease-in-out 0s; ">
         <ul class="node head" id="node" data-isnode="0">
            <li id="node-id-1">
               <a href="javascript:void(0)" class="node-element"><img onmouseover="myFunction('1<?php echo $show_user_id;?>')" data-serialtip="example-1" id="node-img-1" class="tooltipKey user-image" src="<?php echo base_url();?>assets/images/users/avatar-1.jpg" alt="Card image"><span class="tree-username "><?php echo $show_username;?></span></a>
               <div class="popup" >
                      <span class="popuptext" id="1<?php echo $show_user_id;?>">
               ...
               if(count($all_direct_member)>0)
               {
               ?>
               <ul>
                   <?php
                   foreach($all_direct_member as $key=>$val)
                   {
                   ?>
                  <li id="node-id-2">
                     <a href="<?php echo base_url();?>Affiliate/MyGenealogy/directReferralTree/<?php echo $val->user_id;?>" class="node-element"><img onmouseover="myFunction('<?php echo $val->user_id;?>')" data-serialtip="example-2" id="node-img-2" class="tooltipKey user-image" src="<?php echo base_url();?>assets/images/users/avatar-1.jpg" alt="Card image"><span class="tree-username "><?php echo $val->username;?></span></a>
                     <div class="popup" >
