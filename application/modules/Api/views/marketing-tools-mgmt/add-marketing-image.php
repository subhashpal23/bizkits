         ...
         <div class="col-md-12">
            ...
            <div class="card card-flat">
               <div class="card-heading">
                  <h5 class="card-title">Add Marketing Image</h5>
               ...
               <?php 
                  echo form_open(ci_site_url()."Affiliate/MarketingTools/addMarketingImage",array('method'=>'post','class'=>'form-horizontal', 'enctype'=>'multipart/form-data'));
                  ?>
               <div class="card-body">
