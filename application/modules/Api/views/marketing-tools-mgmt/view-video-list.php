                    ...
                    <div class="card-body">
                        <div class="heading-layout1">
                            <div class="item-title">
                                ...
                                <a href="<?php echo ci_site_url();?>Affiliate/MarketingTools/addMarketingVideo" class="btn btn-success"><i class="icon-comment-discussion position-left"></i>Add Marketing Video</a>
                            </div>
               ...
               <tr>
                  ...
                  <td class="text-center">
                     <?php 
                              ...
                              {
                              ?>
                              <a title="click to Publish" href="<?php echo ci_site_url();?>Affiliate/MarketingTools/changeVideoStatus/<?php echo ID_encode($video->id);?>/1"><i class="icon-eye"></i> Publish</a>
                              <?php    
                              }
                              else 
                              {
                              ?>
                              <a title="click to Unpublish" href="<?php echo ci_site_url();?>Affiliate/MarketingTools/changeVideoStatus/<?php echo ID_encode($video->id);?>/0"><i class="icon-eye-blocked"></i> Unpublished</a>
                              <?php    
                              }
                              ?>&nbsp;&nbsp;
                              <a href="<?php echo ci_site_url();?>Affiliate/MarketingTools/deleteVideo/<?php echo ID_encode($video->id);?>"><i class="fa fa-trash"></i></a>
                  </td>
               </tr>
               <?php       
                  }
