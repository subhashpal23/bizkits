            ...
            <div class="card card-body border-top-success">
               ...
               <div class="card card-flat">
                  <div class="card-heading">
                     <h6 class="card-title">Transfer Wallet Fund </h6>
                  </div>
                  <?php 
                  $username=(!empty($username))?$username:null;
                  $amount=(!empty($amount))?$amount:null;
                  $tran_password=(!empty($tran_password))?$tran_password:null;
                  echo form_open(ci_site_url()."Affiliate/Ewallet/ewalletFundTransfer",array('method'=>'post','class'=>'card-body' , 'enctype'=>'multipart/form-data'));
                  ?>
                  <!--<form class="card-body" action="#">-->
                     <div class="form-group has-feedback">
                        <input value="<?php echo set_value('username',$username);?>" type="text" name="username" class="form-control" placeholder="Receiver Id">
                        <span class='error'>
                           <?php 
                     ...
                     <div class="row">
                        ...
                        <div class="col-xs-6 text-right">
                           <button type="submit" name="btn" value="submit" class="btn-fill-lg btn-gradient-yellow btn-hover-bluedark">Transfer  Fund</button>
                        </div>
                     </div>
                  <!--</form>-->
                  <?php echo form_close();?>
