...
<div class="content-wrapper">
   ...
   <div class="page-header page-header-default">
      <div class="page-header-content">
         <div class="page-title">
            <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Payment Set Leg Position</span></h4>
         </div>
      ...
      <div class="breadcrumb-line">
         <ul class="breadcrumb">
            ...
            <li class="active">Set Leg Position</li>
         </ul>
   ...
   <div class="content">
      ...
      <?php  
         ...
         ?>
      <form action="<?php echo ci_site_url();?>user/set_leg_position/" method="post">
         <div class="panel panel-flat">
            <div class="panel-heading">
               <h5 class="panel-title">Set Leg Position</h5>
            </div>
            <div class="panel-content">
               <div class="content">
                <?php 
				  $leg_position_array=array('left'=>'Left','right'=>'Right');
				  foreach($leg_position_array as $k=>$v)
				  {
					 if($leg_position==$k)
					 {
				?>
				  <div class="radio">
                     <label>
                     <input type="radio" value="<?php echo $k;?>" checked="true" name="set_leg_position" class="control-primary">
                     <?php echo $v;?>
                     </label>
                  </div>
				<?php 
				...
				?>
				 <div class="radio">
                     <label>
                     <input type="radio" value="<?php echo $k;?>" name="set_leg_position" class="control-primary">
                     <?php echo $v;?>
                     </label>
                  </div>
				<?php 
            ...
            <div class="content">
               <button type="submit" name="btn" value="add" class="btn btn-primary"><i class="icon-cog3 position-left"></i> Set Leg Position</button>
            </div>
         </div>
      </form>
   </div>
